...
steps:
  - id: MAKEBLASTDB_SILVA_138.1_LSUParc_tax_silva
    run: ../Tools_v1.0/09_makeblastdb_rRNA.cwl
  ...
  - id: BLASTN_rRNA_alignment_silva_138.1_LSUParc_tax_silva
    run: ../Tools_v1.0/10_blastn_rRNA_alignment.cwl
  ...
  - id: BLASTN_rRNA_FILTER1
    run: ../Tools_v1.0/10_blastn_rRNA_filter1.cwl
  ...
  - id: BLASTN_rRNA_FILTER2
    run: ../Tools_v1.0/10_blastn_rRNA_filter2.cwl
