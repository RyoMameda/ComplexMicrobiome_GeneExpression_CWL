...
steps:
  - id: DIAMOND_INDEX
    run: ../Tools_v1.0/09_diamond_index.cwl
    in:
  ...
  - id: DIAMOND_ALIGNMENT
    run: ../Tools_v1.0/11_diamond_uniprot_alignment.cwl
    in:
      threads: THREADS
  ...
  - id: DIAMOND_FILTER1
    run: ../Tools_v1.0/11_diamond_uniprot_filter1.cwl
    in:
  ...
  - id: DIAMOND_FILTER2
    run: ../Tools_v1.0/11_diamond_uniprot_filter2.cwl
    in:
